...
const updateProduct = async(req, res)=>{
    ...
    const product = await Product.findByIdAndUpdate(id ,{name, description,stock,category,price},
        {new : true , runValidator : true }
    )
    return res.status(200).json({success : true , message : "product is update with success", data : product })
...
module.exports = {createProduct , updateProduct,getAllProduct ,getOneProduct, deleteProduct }